  ...
  return (
    <>
      ...
      <button 
        ...
        className={`md:hidden fixed top-20 left-4 z-40 bg-stone-800 text-stone-200 px-4 py-2.5 rounded-xl shadow-2xl border flex items-center gap-2 font-bold transition-all ${isOpen ? 'translate-x-[-150%] opacity-0 border-stone-700' : 'translate-x-0 opacity-100 border-amber-600/50 hover:bg-stone-700'}`}
      >
