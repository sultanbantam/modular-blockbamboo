...
export function AdvancedControls() {
  ...
  return (
    <>
      ...
      {/* Sliding Drawer */}
      <div 
        className={`fixed right-0 bottom-0 lg:top-[60px] h-[60vh] lg:h-auto lg:bottom-4 w-full lg:w-72 bg-stone-900/95 border-t lg:border-l lg:border-t-0 border-stone-800 p-6 flex flex-col pointer-events-auto shadow-2xl backdrop-blur-xl z-50 transition-transform duration-300 ease-in-out lg:rounded-l-xl ${isOpen ? 'translate-y-0 lg:translate-y-0 lg:translate-x-0' : 'translate-y-full lg:translate-y-0 lg:translate-x-full'}`}
      >
